...
class BuySellPostCard2 extends StatefulWidget {
  final Map<String, dynamic> snap;

  final String hello;
  const BuySellPostCard2({Key? key, required this.snap, required this.hello}) : super(key: key);

  @override
  _BuySellPostCardState2 createState() => _BuySellPostCardState2();
}

class _BuySellPostCardState2 extends State<BuySellPostCard2> {
  String name="name";
  String email="email";
  String phone="phone";
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  SizedBox(
                    height: 300,
                    child: Slideshow(images: tempimages),
                  ),
                  Row(
